...
public class PluginVideoServiceManager {
    ...
    public PluginVideoSourceDescriptor getVideoSourceInfo(String baseUrl) throws PluginVideoServiceException {
        PluginVideoServiceClient client = new PluginVideoServiceClient(baseUrl);
        return client.processResponse(client.getService().getVideoSourceInfo());
    }
